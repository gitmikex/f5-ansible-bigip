...
def stub_unit_test_file(module, extension):
    test_dir_path = '{0}/ansible_collections/f5networks/f5_bigip/tests/unit/modules/network/f5/'.format(BASE_DIR)
    if not os.path.exists(test_dir_path):
        os.makedirs(test_dir_path)
    test_file = '{0}/ansible_collections/f5networks/f5_bigip/tests/unit/modules/network/f5/test_{1}{2}'.format(
        BASE_DIR, module, extension
    )
